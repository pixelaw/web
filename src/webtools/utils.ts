...
if (import.meta.vitest) {
    ...
    describe("viewToWorld should correctly return world coordinates", () => {
        it("all 0, should return all 0 too", () => expect(applyWorldOffset([0, 0], [0, 0])).toEqual([0, 0]))
        ...
        it("Moving [-1,-1] by 2 to rightbottom", () =>
            expect(applyWorldOffset([4_294_967_294, 4_294_967_294], [4_294_967_295, 4_294_967_295])).toEqual([1, 1]))
    ...
    describe("applyWorldOffset should return correct cell coordinates", () => {
        ...
        it("160 minus 1", () => expect(applyWorldOffset([4294967295, 0], [160, 0])).toEqual([161, 0]))
    ...
    describe("cellForPosition should return correct cell coordinates", () => {
        ...
        it("realistic", () => expect(cellForPosition(10000, [0, 25], [298.5, 44.15625])).toEqual([1, 0]))
    })
