import { interpret, isInstruction, type ParamDefinitionType, type Variant } from './Instruction.ts';
import { type InterfaceType, type Manifest } from '@/global/types.ts';
...
export default function getParamsDef(
    ...
    return parameters.map((param) => {
        ...
        const isPrimitiveType =
            param.type.includes('core::integer') || param.type.includes('core::felt252');
